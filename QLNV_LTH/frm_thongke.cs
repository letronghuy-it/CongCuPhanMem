...
namespace QLNV_LTH
{
    public partial class frm_thongke : Form
    {
        ...
        private void comboBox_chonnhanvien_SelectedIndexChanged(object sender, EventArgs e)
        {
            textBox_manv.Text = comboBox_chonnhanvien.SelectedValue.ToString();
            textBox_manv.Visible = true;
        }

        private void dataGridView_thongkeluong_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
