                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            string sqlCreateAcc = "insert into dangnhap (tendangnhap, tennguoidung, matkhau, trangthai, ngaytao) " +
                      "values('" + textBox_tendangnhap.Text + "', N'" + textBox_tennguoidung.Text + "', N'"
                      + textBox_matkhau.Text + "', 1, convert(datetime, '"
                      + today.ToString("yyyy-MM-dd") + "', 102))";
